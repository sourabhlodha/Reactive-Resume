  ...
  <Card className="space-y-4 bg-info text-info-foreground">
    <CardContent className="space-y-2">
      ...
      <CardDescription className="space-y-2">
        <Trans>
          <p>
            I built ResumeU mostly by myself during my spare time, with a lot of help from other
    ...
    <CardFooter>
      ...
      >
        ...
        <span className="line-clamp-1">{t`Donate to ResumeU`}</span>
      </a>
    </CardFooter>
  </Card>
);
  ...
  <Card className="space-y-4">
    <CardContent className="space-y-2">
      ...
      <CardDescription className="space-y-2">
        <Trans>
          <p>
            The community has spent a lot of time writing the documentation for ResumeU, and I'm
