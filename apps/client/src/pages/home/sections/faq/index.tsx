...
// Who are you, and why did you build ResumeU?
const Question1 = () => (
  <AccordionItem value="1">
    ...
    <AccordionContent className="prose max-w-none dark:prose-invert">
      ...
      <p>
        ...
        to build the first version of ResumeU in 2019. Since then, it's gone through multiple
        iterations as I've learned a lot of better coding practices over the years.
      </p>

      <p>
        At the time of writing, ResumeU is probably one of the only handful of resume builders out
      ...
      <p>
        ...
        basis, and I'm extremely proud to say that ResumeU, over it's years of development, has{" "}
...
// How much does it cost to run ResumeU?
const Question2 = () => (
  <AccordionItem value="2">
    ...
    <AccordionContent className="prose max-w-none dark:prose-invert">
      <p>
        ...
        graciously sponsored their infrastructure to allow me to host ResumeU on their platform.
  ...
  <AccordionItem value="3">
    ...
    <AccordionContent className="prose max-w-none dark:prose-invert">
      ...
      <p>
        ...
        that's wishful thinking. But if you do mention ResumeU on your blog, let me know so that I
...
// What languages are supported on ResumeU?
const Question4 = () => {
  ...
  return (
    <AccordionItem value="4">
      ...
      <AccordionContent className="prose max-w-none dark:prose-invert">
        <p>
          Here are the languages currently supported by ResumeU, along with their respective
  ...
  <AccordionItem value="5">
    ...
    <AccordionContent className="prose max-w-none dark:prose-invert">
      <p>
        ...
        me in my everyday work and with the development of ResumeU. It only makes sense that you
      ...
      <p>
        ...
        adding a key in the Settings page and still make use of all the useful features that ResumeU
        has to offer. I would even suggest you to take the extra step of using ChatGPT to write your
        content, and simply copy it over to ResumeU.
      </p>
    </AccordionContent>
  </AccordionItem>
);
    ...
    <div className="grid gap-12 lg:grid-cols-3">
      <div className="space-y-6">
        ...
        <p className="text-base leading-loose">
          Here are some questions I often get asked about ResumeU.
        </p>
